...
-- Media Controls Popup Rules
hl.window_rule({ match = { title = "MediaControlsPopup" }, float = true })
hl.window_rule({ match = { title = "MediaControlsPopup" }, pin = true })
hl.window_rule({ match = { title = "MediaControlsPopup" }, no_shadow = true })
