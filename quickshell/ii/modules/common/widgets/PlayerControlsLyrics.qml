    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Lyrics {
                ...
                activeColor: ColorUtils.mix(root.blendedColors.colPrimary, "#ffffff", 0.5)
        ...
        ColumnLayout {
            ...
            Item {
                ...
                StyledText {
                    ...
                    text: `${StringUtils.friendlyTimeForSeconds(root.safePosition)} / ${StringUtils.friendlyTimeForSeconds(root.player?.length)}`
                }
                    ...
                    Item {
                        ...
                        Loader {
                            ...
                            sourceComponent: StyledSlider {
                                ...
                                value: root.safePosition / root.player?.length
                                onMoved: {
